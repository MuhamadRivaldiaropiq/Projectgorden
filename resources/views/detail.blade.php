<x-app-layout>
    ...
    <section class="max-w-[31rem] mx-auto bg-white shadow-2xl">
        ...
        <div>
            ...
            <div class="text-center text-base mt-7 mb-3">{{ $data->paragraf_1 }}</div>
    ...
    <main class="mx-auto bg-blue-400 shadow-2xl pt-5">
        ...
        <div class="grid grid-cols-1 grid-rows-3 gap-5 p-5">
           <div class="bg-white p-3 flex rounded-lg">
            <img src="/images/produk1.jpeg" alt="" class="w-40">
            <div class="ml-4 my-auto">
                <div class="text-lg font-semibold">Pemasangan Gorden</div>
                <div class="text-base">Melayani pemasangan gorden dapat disesuaikan dengan kebutuhan anda.</div>
            </div>
           </div>
           <div class="bg-white p-3 flex rounded-lg">
            <img src="/images/produk2.jpeg" alt="" class="w-40">
            <div class="ml-4 my-auto">
                <div class="text-lg font-semibold">Perbaikan dan Restorasi</div>
                <div class="text-base">Selain itu, kami juga dapat membantu dalam perbaikan dan restorasi gorden yang rusak atau tua, termasuk pembuatan ulang.</div>
            </div>
           </div>
           <div class="bg-white p-3 flex rounded-lg">
            <img src="/images/produk3.jpeg" alt="" class="w-40">
            <div class="ml-4 my-auto">
                <div class="text-lg font-semibold">Custom Gorden</div>
                <div class="text-base">Jika Anda memiliki kebutuhan khusus, kami dapat membantu dalam mengkustom gorden, tentu saja dalam pilihan anda sendiri.</div>
            </div>
           </div>
        </div>
        <div class="flex justify-center mt-10">
